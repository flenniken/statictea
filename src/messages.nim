...
const
  Messages*: array[low(MessageId)..high(MessageId), string] = [
    ...
    "Duplicate short option: '-$1'.",
    "Duplicate long option: '--$1'.",
    "Use the short name '_' instead of '$1' with a bare parameter.",
    "Use an alphanumeric ascii character for a short option name instead of '$1'.",
    "Missing '$1' parameter.",
