...
"""
  ...
  info = newBuiltInInfo
  functionsList = [
    info("fun_add_fff", dc_fun_add_fff, 24),
    info("fun_add_iii", dc_fun_add_iii, 25),
    info("fun_anchors_lsl", dc_fun_anchors_lsl, 39),
    info("fun_bool_ab", dc_fun_bool_ab, 38),
    info("fun_case_iloaa", dc_fun_case_iloaa, 46),
    info("fun_case_sloaa", dc_fun_case_sloaa, 45),
    info("fun_cmp_ffi", dc_fun_cmp_ffi, 22),
    info("fun_cmp_iii", dc_fun_cmp_iii, 22),
    info("fun_cmp_ssobi", dc_fun_cmp_ssobi, 34),
    info("fun_cmpVersion_ssi", dc_fun_cmpVersion_ssi, 45),
    info("fun_dict_old", dc_fun_dict_old, 37),
    info("fun_dup_sis", dc_fun_dup_sis, 41),
    info("fun_echo_ss", dc_fun_echo_ss, 24),
    info("fun_exists_dsb", dc_fun_exists_dsb, 23),
    info("fun_find_ssoaa", dc_fun_find_ssoaa, 39),
    info("fun_float_if", dc_fun_float_if, 18),
    info("fun_float_saa", dc_fun_float_saa, 28),
    info("fun_float_sf", dc_fun_float_sf, 27),
    info("fun_format_ss", dc_fun_format_ss, 33),
    info("fun_func_sp", dc_fun_func_sp, 23),
    info("fun_functionDetails_pd", dc_fun_functionDetails_pd, 36),
    info("fun_get_dsoaa", dc_fun_get_dsoaa, 42),
    info("fun_get_lioaa", dc_fun_get_lioaa, 49),
    info("fun_html_sss", dc_fun_html_sss, 41),
    info("fun_if_baoaa", dc_fun_if_baoaa, 42),
    info("fun_int_fosi", dc_fun_int_fosi, 37),
    info("fun_int_sosi", dc_fun_int_sosi, 44),
    info("fun_int_ssaa", dc_fun_int_ssaa, 36),
    info("fun_join_loss", dc_fun_join_loss, 40),
    info("fun_joinPath_loss", dc_fun_joinPath_loss, 35),
    info("fun_keys_dl", dc_fun_keys_dl, 25),
    info("fun_len_di", dc_fun_len_di, 20),
    info("fun_len_li", dc_fun_len_li, 20),
    info("fun_len_si", dc_fun_len_si, 19),
    info("fun_list_al", dc_fun_list_al, 22),
    info("fun_log_ss", dc_fun_log_ss, 26),
    info("fun_loop_lapoab", dc_fun_loop_lapoab, 49),
    info("fun_lower_ss", dc_fun_lower_ss, 20),
    info("fun_not_bb", dc_fun_not_bb, 19),
    info("fun_parseCode_sl", dc_fun_parseCode_sl, 46),
    info("fun_parseMarkdown_ssl", dc_fun_parseMarkdown_ssl, 80),
    info("fun_path_sosd", dc_fun_path_sosd, 56),
    info("fun_readJson_sa", dc_fun_readJson_sa, 29),
    info("fun_replace_siiss", dc_fun_replace_siiss, 111),
    info("fun_replaceRe_sls", dc_fun_replaceRe_sls, 34),
    info("fun_return_aa", dc_fun_return_aa, 65),
    info("fun_slice_siois", dc_fun_slice_siois, 36),
    info("fun_sort_lsosl", dc_fun_sort_lsosl, 33),
    info("fun_sort_lssil", dc_fun_sort_lssil, 28),
    info("fun_sort_lsssl", dc_fun_sort_lsssl, 28),
    info("fun_startsWith_ssb", dc_fun_startsWith_ssb, 21),
    info("fun_string_aoss", dc_fun_string_aoss, 108),
    info("fun_string_dsss", dc_fun_string_dsss, 33),
    info("fun_sub_fff", dc_fun_sub_fff, 26),
    info("fun_sub_iii", dc_fun_sub_iii, 25),
    info("fun_type_as", dc_fun_type_as, 59),
    info("fun_values_dl", dc_fun_values_dl, 124),
    info("fun_warn_ss", dc_fun_warn_ss, 26),
  ]
