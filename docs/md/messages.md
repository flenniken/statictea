...
Messages: array[low(MessageId) .. high(MessageId), string] = ["Success.", "",
    ...
    "Specify arguments in pairs.", "None of the case conditions match the main condition and there is no else case.",
    ...
    "The variable is not a dictionary.", "Specify u, f or a function variable.",
