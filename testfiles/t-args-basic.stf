...
$$ endblock
$$ block
$$ : g.templateParts &= concat("--server ", t.args.templateFilename)
$$ endblock
...
t.args keys:
  ...
  ["help","version","update","log","serverList","sharedList","resultFilename","templateFilename","logFilename","prepostList"]
...
t.args:
  ...
  {"help":0,"version":0,"update":0,"log":1,"serverList":["server.json","server2.json"],"sharedList":["shared.json","shared2.json"],"resultFilename":"result.html","templateFilename":"template.html","logFilename":"","prepostList":[["abc$","def"],["$$",""]]}
