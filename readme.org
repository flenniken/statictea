...
- [[#funAdd_Fi][add()]] -- Add floats.
- [[#funAdd_Ii][add()]] -- Add integers.
- [[#funCase_iaIAa][case()]] -- Compare integer cases and return the matching value.
- [[#funCase_saSAa][case()]] -- Compare string cases and return the matching value.
- [[#funCmpVersion][cmpVersion()]] -- Compare two StaticTea version numbers.
- [[#funCmp_ffi][cmp()]] -- Compare two floats.
- [[#funCmp_iii][cmp()]] -- Compare two ints.
- [[#funCmp_ssoii][cmp()]] -- Compare two strings.
- [[#funConcat][concat()]] -- Concatentate two or more strings.
- [[#funDict][dict()]] -- Create a dictionary from a list of key, value pairs.
- [[#funDup][dup()]] -- Duplicate a string x times.
- [[#funExists][exists()]] -- Determine whether a key exists in a dictionary.
- [[#funFind][find()]] -- Find the position of a substring in a string.
- [[#funFloat_if][float()]] -- Create a float from an int.
- [[#funFloat_sf][float()]] -- Create a float from a number string.
- [[#funGet_dsoaa][get()]] -- Get a dictionary value by its key.
- [[#funGet_lioaa][get()]] -- Get list value by its index.
- [[#funGithubAnchor][githubAnchor()]] -- Create a Github markdown anchor name given a heading name.
- [[#funIf][if()]] -- If the condition is 1 return one value, else return another
value.
- [[#funInt_fosi][int()]] -- Create an int from a float.
- [[#funInt_sosi][int()]] -- Create an int from a number string.
- [[#funKeys][keys()]] -- Create a list from the keys in a dictionary.
- [[#funLen_di][len()]] -- Number of elements in a dictionary.
- [[#funLen_li][len()]] -- Number of elements in a list.
- [[#funLen_si][len()]] -- Length of a string in characters, not bytes.
- [[#funList][list()]] -- Create a list of values.
- [[#funLower][lower()]] -- Lowercase a string.
- [[#funPath][path()]] -- Split a file path into pieces.
- [[#funReplace][replace()]] -- Replace a substring specified by its position and length with
another string.
- [[#funReplaceRe_sSSs][replaceRe()]] -- Replace multiple parts of a string using regular expressions.
- [[#funReplaceRe_sls][replaceRe()]] -- Replace multiple parts of a string using regular expressions.
- [[#funSort_lsosl][sort()]] -- Sort a list of values of the same type.
- [[#funSort_lssil][sort()]] -- Sort a list of lists.
- [[#funSort_lsssl][sort()]] -- Sort a list of dictionaries.
- [[#funSubstr][substr()]] -- Extract a substring from a string by its position.
- [[#funValues][values()]] -- Create a list out of the values in the specified dictionary.
