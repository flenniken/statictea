...
In the commands you format the passed in json variables or you
crate new variables for use in the replacement block.

You specify the commands so the look like comments for your
template type.
...
digits or underscores.  They are limited to xxx characters.
...
define a literal string by wrapping it with double quotes.
...
Strings are encoded as UTF-8 and invalid UTF-8 byte sequences
generate a warning.
...
- "ending newline\n"
- "tab \t in the middle"
- "Mad Hatterl: \\\"... you must have a cup of tea!\\\" - 'Alice In Wonderland'."
- "Unicode tea character '茶' is '\u8336'"
- "smiley face 😀 by escaping: \uD83D\uDE00."

You can enter any unicode values with \u and four hex digits or, for
