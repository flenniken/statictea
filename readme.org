#+TITLE: StaticTea: A template processor and language.
...
values. It takes two or three parameters. The first is the list or
...
the statement is skipped. Added in version 0.1.0.
...
parameter is returned, else the third parameter is returned. Added in version 0.1.0.
