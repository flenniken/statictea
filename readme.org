...
the second is the substring. The third optional parameter is
returned when the substring is not found.  A warning is generated
when the substring is missing and no third parameter. Positions
...
starting position and the third is the length of the substring
and the forth is the string to replace.
