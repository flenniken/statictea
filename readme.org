...
- [[#int][int()]] -- convert a float or float number string to an int
- [[#exists][exists()]] -- whether a variables exists
- [[#find][find()]] -- find a substring in a string
- [[#floatfun][float()]] -- convert an int or int number string to a float
...
The float function converts an int or an number string to a
float.
