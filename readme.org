...
The doc comment come next and they tell what the function does:
...
use "any" to when it accepts any type. The built-in get function
...
True and false are variables in the local dictionary.  You can
define variables called true and false in other dictionaries.
