...
the functions and type exists in the source code as nim doc
...
- [[docs/rmFunctions.md][Functions]]
- [[templates/rmFunctions.md][rmFunctions.md]] (view raw)
- [[templates/rmFunctions.tea][rmFunctions.tea]]
...
by the nimble task *cdy*. The template creates a nim source file
that’s compiled in.
...
file. The nimble *stfrm* task extracts a sentence from the top of each
stf file and makes an index from that with a template.

- [[templates/readme.md][readme.md]] (view raw)
...
funcdocs nimble task which uses the StaticTea template
[[templates/rmFunctions.md][rmFunctions.md template]].

- [[docs/rmFunctions.md][Functions]] -- Build-in Function Docs
