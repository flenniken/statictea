...
Strings follow the same escaping rules as json strings.
...
all the stf files.  There are nimble tasks for these:

- br -- build the stf runner application
- stf -- list the stf descriptions
