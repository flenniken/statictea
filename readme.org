...
Follow these guidelines when creating a new template:

1. Create a sample result file. For HTML create an HTML
   file. This will become your template.

Open and test the template after each step in the process. For
example an HTML file you would open it in a browser and validate
it.
...
- [[templates/stf-index.md][StaticTea Stf Files]] (view raw)
...
- [[docs/teaFunctions.md][Functions]] -- Built-in Function Docs
