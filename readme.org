...
- [[#tcase][t.case()]] -- generalized if function
- [[#tcmp][t.cmp()]] -- spaceship compare function <=>
- [[#tconcat][t.concat()]] -- concatenate strings
- [[#tcopy][t.copy()]] -- copy variables to the local dictionary
- [[#tcurrency][t.currency()]] -- format currency
- [[#texists][t.exists()]] -- whether a variables exists
- [[#tfind][t.find()]] -- find a substring in a string
- [[#tformat][t.format()]] -- format a string
- [[#tif][t.if()]] -- if function
- [[#tlen][t.len()]] -- length of string
- [[#tquotehtml][t.quoteHtml]] -- replace html special characters
- [[#trow][t.row()]] -- special function that returns the current row
- [[#tsizes][t.sizes()]] -- format bytes counts, KB, MB, GB, etc.
- [[#tsubstr][t.substr()]] -- extract a substring from a string by indexes
- [[#ttime][t.time()]] -- format the date and time.
- [[#tversion][t.version()]] -- the current version and version checker
- [[#twarn][t.warn()]] -- format a warning message with file and line number.
...
#+BEGIN_SRC
<!--$ block \-->
<!--$ : sold = t.cmp(s.earlgrey, s.oolong); \-->
<!--$ : bestSelling = t.case(sold, \-->
<!--$ :   s.earlgreyName, -1, s.oolongName) -->
The best selling tea this
week is {s.bestSelling}.
<!--$ endblock -->
#+END_SRC
