...
content. This defines the replacement block.
...
statements multiple times usint t.repeat, and vary the output using
t.row. Here is an example the loops three times and outputs 1, 2, 3.
