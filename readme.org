...
define variables. You use commas to separate statements.
...
row function and 0, 1 for false and true.
...
version = "t.version" [s minVersion] | "t.version" os "(" os [minVersion [os "," os maxVersion]] os ")"
