...
- [[#ifNot0][ifNot0()]] -- If the condition is not 0, return the second parameter, else return the third.
...
- [[#join][join()]] -- Join the list of string components with the given separator.
