...
The if0 function is special in a couple of ways. It conditionally
evaluate its arguments and it can be used in a statement bare
without an assignment.

You use the bare form with the warn and return functions for
their side effects.

The if0 function evaluates the condition parameter first to
...
- [[#eq][eq]] -- Return true when the two arguments are equal.
- [[#eq][eq]] -- Return true when the two arguments are equal.
- [[#eq][eq]] -- Return true when the two arguments are equal.
...
- [[#lte][lte]] -- Return true when the a is less than or equal to b.
- [[#ne][ne]] -- Return true when the two arguments are not equal.
- [[#ne][ne]] -- Return true when the two arguments are not equal.
- [[#ne][ne]] -- Return true when the two arguments are not equal.
- [[#not][not]] -- Boolean not.
