...
- [[#add_Fi][add_Fi()]] -- Add floats.
- [[#add_Ii][add_Ii()]] -- Add integers.
- [[#case_iaIAa][case_iaIAa()]] -- Return a value from multiple choices.
- [[#case_saSAa][case_saSAa()]] -- Return a value from multiple choices.
...
- [[#find][find()]] -- Return the position of a substring in a string.
- [[#float_if][float_if()]] -- Create a float from an int.
- [[#float_sf][float_sf()]] -- Create a float from a number string.
- [[#get_dsoaa][get_dsoaa()]] -- Return a value in a dictionary by key.
- [[#get_lioaa][get_lioaa()]] -- Return a value from a list by its index.
- [[#githubAnchor][githubAnchor()]] -- Create a Github markdown anchor name given a heading name.
- [[#if][if()]] -- Return a value when the condition is 1 and another value when the
condition is not 1.
- [[#int_fosi][int_fosi()]] -- Create an int from a float.
- [[#int_sosi][int_sosi()]] -- Create an int from a number string.
- [[#keys][keys()]] -- Create a list from the keys in a dictionary.
- [[#len_di][len_di()]] -- Return the number of elements in a dictionary.
- [[#len_li][len_li()]] -- Return the number of elements in a list.
- [[#len_si][len_si()]] -- Return the length of a string in characters, not bytes.
...
- [[#replaceRe_sSSs][replaceRe_sSSs()]] -- Replace multiple parts of a string using regular expressions.
- [[#replaceRe_sls][replaceRe_sls()]] -- Replace multiple parts of a string using regular expressions.
- [[#sort_lsosl][sort_lsosl()]] -- Sort a list of values of the same type.
- [[#sort_lssil][sort_lssil()]] -- Sort a list of lists.
- [[#sort_lsssl][sort_lsssl()]] -- Sort a list of dictionaries.
